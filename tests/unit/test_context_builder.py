...
def test_build_citation_context_formatting():
    ...
    chunks = [
        RetrievedChunk(
            chunk_id="c1", arxiv_id="1234.5678", paper_id="p1", section_title="Introduction", chunk_type="body",
            text="This is a sentence about self-attention.", title="Transformer Paper", authors=["Author A"],
            abstract="Abstract here", categories=["cs.LG"], published_date="2026-01-01", score=0.9
        ),
        RetrievedChunk(
            chunk_id="c2", arxiv_id="8765.4321", paper_id="p2", section_title="Conclusion", chunk_type="body",
            text="This is a sentence about linear-time SSMs.", title="Mamba Paper", authors=["Author B"],
            abstract="Abstract here", categories=["cs.CL"], published_date="2026-01-02", score=0.85
        )
    ]
